...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  // main page (index.html).
  //
  // TODO: STEP 1: Substitute [...buildAndShowHomeHTML...] below with the value
  // of the function buildAndShowHomeHTML, so it can be called when server responds
  // with the categories data.
